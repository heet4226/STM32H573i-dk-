...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PF11     ------> ADC1_INP2
    */
    HAL_GPIO_DeInit(GPIOA, ARD_A1_Pin|ARD_A2_Pin|ARD_A4_Pin|ARD_A3_Pin);

    HAL_GPIO_DeInit(GPIOF, ARD_A5_Pin|STMOD_13_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI5)
  {
    ...
    PF7     ------> SPI5_SCK
    */
    HAL_GPIO_DeInit(GPIOF, STMOD_12_RST_Pin|STMOD_9_MISOs_Pin|GPIO_PIN_7);
