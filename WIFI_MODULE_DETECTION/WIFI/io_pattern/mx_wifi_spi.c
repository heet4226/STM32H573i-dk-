...
#define MX_WIFI_RESET_PIN        GPIO_PIN_6
#define MX_WIFI_RESET_PORT       GPIOH

/* wifi spi cs */
#define MX_WIFI_SPI_CS_PIN       GPIO_PIN_6
#define MX_WIFI_SPI_CS_PORT      GPIOF

/* wifi spi slave notify */
#define MX_WIFI_SPI_IRQ_PIN      GPIO_PIN_9
#define MX_WIFI_SPI_IRQ_PORT     GPIOH
#define MX_WIFI_SPI_IRQ          EXTI9_IRQn

#define MX_WIFI_SPI_FLOW_PIN     GPIO_PIN_7
#define MX_WIFI_SPI_FLOW_PORT    GPIOH
