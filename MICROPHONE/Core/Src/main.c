...
#define PCM_SAMPLES           16
#define PDM_BUFFER_SIZE_BYTES (PCM_SAMPLES * DECIMATION_FACTOR / 8)

uint8_t  pdm_raw[PDM_BUFFER_SIZE_BYTES];  // 128 bytes
volatile int16_t pcm_out[PCM_SAMPLES];            // 16 PCM samples
