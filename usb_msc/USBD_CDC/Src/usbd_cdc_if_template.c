...
/*personal not: je buffer declare karta che static tarike e null no hova joie*/
/*personal not: tmplate init valu function che e ema null ni jagya e hamesha kaik value buffer tarike rakhvi nakar code 10 ni error avse*/
