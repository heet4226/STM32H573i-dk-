...
/* Private typedef -----------------------------------------------------------*/
#undef USBD_CLASS_BOS_ENABLED
#define USBD_CLASS_BOS_ENABLED 0

/* Private define ------------------------------------------------------------*/
#define USBD_VID                      0x0483
#define USBD_PID                      0x5740  /* Replace '0xaaaa' with your device product ID */
#define USBD_LANGID_STRING            1033    /* 0x5731 Replace '0xbbb' with your device language ID */
#define USBD_MANUFACTURER_STRING      "STMicroelectronics" /* Add your manufacturer string */
#define USBD_PRODUCT_FS_STRING        "USB COM port" /* Add your product High Speed string */
#define USBD_PRODUCT_Class_STRING     "STM32 CDC Device" /* Add your product Full Speed string */
...
#define USBD_CONFIGURATION_FS_STRING  "CDC string" /* Add your configuration Full Speed string */
...
__ALIGN_BEGIN uint8_t USBD_DeviceDesc[USB_LEN_DEV_DESC] __ALIGN_END =
{
  ...
  0x02,                       // bDeviceSubClass (Abstract Control Model) // ahiya darek mode mate
  0x00,                       // bDeviceProtocol (No specific protocol)  // a 3 lines in value alag alag hoy che to e pramane joy levu
